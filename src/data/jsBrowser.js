export const jsBrowserQuestions = [
  // ================ DOM STRUCTURE & TRAVERSAL (1-9) ================
  {
    id: "dom-struct-001",
    ...
    correct: [1],
    explanation: "DOM (Document Object Model) — это представление HTML/XML документа в виде дерева объектов (узлов), которое JavaScript может читать и изменять."
  },
  {
    id: "dom-struct-002",
    topic: "DOM Structure & Traversal",
    ...
    correct: [1],
    explanation: "Основные типы узлов: ELEMENT_NODE (1), TEXT_NODE (3), COMMENT_NODE (8), DOCUMENT_NODE (9), DOCUMENT_TYPE_NODE (10)."
  },
  {
    id: "dom-struct-003",
    topic: "DOM Structure & Traversal",
  ...
  },
  {
    ...
    correct: [1],
    explanation: "parentNode возвращает родительский узел (любой тип), parentElement возвращает только родителя-элемент."
  },
  {
    id: "dom-struct-005",
    topic: "DOM Structure & Traversal",
    ...
    correct: [0],
    explanation: "children — только дочерние элементы (HTMLCollection), childNodes — все дочерние узлы, включая текст и комментарии (NodeList)."
  },
  {
    id: "dom-struct-006",
    topic: "DOM Structure & Traversal",
    ...
    correct: [1],
    explanation: "firstElementChild возвращает первый дочерний элемент (игнорирует текстовые узлы). firstChild может вернуть текст или комментарий."
  },
  {
    id: "dom-struct-007",
    topic: "DOM Structure & Traversal",
    ...
    correct: [1],
    explanation: "nextElementSibling возвращает следующий элемент-сосед. nextSibling может вернуть текстовый узел."
  },
  {
    id: "dom-struct-008",
    topic: "DOM Structure & Traversal",
    ...
    correct: [1],
    explanation: "getElementsByTagName и getElementsByClassName возвращают живые HTMLCollection. querySelectorAll возвращает статический NodeList."
  },
  {
    id: "dom-struct-009",
    topic: "DOM Structure & Traversal",
  ...
  },
  {
    ...
    correct: [2],
    explanation: "appendChild() добавляет узел в конец, append() современный метод с поддержкой текста и нескольких аргументов."
  },
  {
    id: "dom-manip-012",
    topic: "DOM Manipulation",
    ...
    correct: [0],
    explanation: "innerHTML работает внутри элемента, outerHTML заменяет сам элемент (включая его теги)."
  },
  {
    id: "dom-manip-013",
    topic: "DOM Manipulation",
    ...
    correct: [1],
    explanation: "Атрибуты задаются в HTML (всегда строки), свойства появляются у DOM-объекта после парсинга (могут быть любого типа)."
  },
  {
    id: "dom-manip-014",
    topic: "DOM Manipulation",
    ...
    correct: [1],
    explanation: "При изменении свойства атрибут не обновляется. Атрибут хранит начальное значение, свойство — текущее."
  },
  {
    id: "dom-manip-015",
    topic: "DOM Manipulation",
    ...
    correct: [2],
    explanation: "insertAdjacentHTML позволяет вставить HTML строку в указанную позицию: beforebegin, afterbegin, beforeend, afterend."
  },
  {
    id: "dom-manip-016",
    topic: "DOM Manipulation",
  ...
  },
  {
    ...
    correct: [2],
    explanation: "Оба метода работают, но getElementById быстрее, а querySelector гибче (поддерживает любые селекторы)."
  },
  {
    id: "dom-manip-018",
    topic: "DOM Manipulation",
    ...
    correct: [0],
    explanation: "removeEventListener требует точно такую же функцию и параметры, как при добавлении. Анонимные функции удалить нельзя."
  },
  {
    id: "dom-manip-019",
    topic: "DOM Manipulation",
    ...
    correct: [1],
    explanation: "focus() устанавливает фокус на элементе (например, на поле ввода), чтобы пользователь мог сразу начать печатать."
  },
  ...
  // ================ EVENTS (20-35) ================
  {
    ...
    correct: [1],
    explanation: "Три способа: 1) атрибут HTML (устарел), 2) свойство вроде element.onclick, 3) современный addEventListener."
  },
  {
    id: "events-021",
    topic: "Events",
    ...
    correct: [1],
    explanation: "addEventListener позволяет назначить несколько обработчиков, а onclick перезаписывает предыдущий."
  },
  {
    id: "events-022",
    topic: "Events",
    question: "Сколько аргументов принимает addEventListener?",
    options: ["1 аргумент", "2 аргумента", "3 аргумента (type, listener, options)", "Неограниченное количество"],
    correct: [2],
    explanation: "addEventListener принимает 3 аргумента: тип события, функцию-обработчик и объект/флаг настроек (необязательный)."
  },
  {
    id: "events-023",
    topic: "Events",
    ...
    correct: [1],
    explanation: "Event Propagation — это распространение события: сначала фаза перехвата (capturing), потом цель (target), затем всплытие (bubbling)."
  },
  {
    id: "events-024",
    topic: "Events",
    ...
    correct: [1],
    explanation: "Делегирование — обработчик вешается на родителя и ловит события от детей. Экономит память и работает с динамическими элементами."
  },
  {
    id: "events-025",
    topic: "Events",
    ...
    correct: [1],
    explanation: "target указывает на элемент, который инициировал событие. currentTarget — на элемент, на котором висит обработчик."
  },
  {
    id: "events-026",
    topic: "Events",
    ...
    correct: [1],
    explanation: "preventDefault отменяет стандартное поведение браузера: переход по ссылке, отправку формы, выделение текста и т.д."
  },
  {
    id: "events-027",
    topic: "Events",
    ...
    correct: [1],
    explanation: "stopPropagation останавливает дальнейшее распространение события (не дает ему всплывать к родителям)."
  },
  {
    id: "events-028",
    topic: "Events",
    ...
    correct: [1],
    explanation: "stopPropagation — только остановка всплытия. stopImmediatePropagation — остановка всплытия + отключение всех остальных обработчиков на текущем элементе."
  },
  {
    id: "events-029",
    topic: "Events",
    ...
    correct: [1],
    explanation: "DOMContentLoaded срабатывает после загрузки и парсинга HTML. load — после загрузки всех ресурсов (картинки, стили, iframe)."
  },
  {
    id: "events-030",
    topic: "Events",
    ...
    correct: [0],
    explanation: "События мыши: click, dblclick, mousedown, mouseup, mousemove, mouseenter, mouseleave и другие."
  },
  {
    id: "events-031",
    topic: "Events",
    ...
    correct: [1],
    explanation: "Основные события клавиатуры: keydown (нажатие) и keyup (отпускание). keypress устарел."
  },
  {
    id: "events-032",
    topic: "Events",
    ...
    correct: [1],
    explanation: "События форм: input (ввод), change (изменение), submit (отправка), focus (фокус), blur (потеря фокуса)."
  },
  {
    id: "events-033",
    topic: "Events",
  ...
  },
  {
    ...
    correct: [0],
    explanation: "passive: true указывает, что обработчик не вызовет preventDefault, улучшая производительность прокрутки."
  },
  {
    id: "events-035",
    topic: "Events",
    ...
    correct: [1],
    explanation: "Свойство event.defaultPrevented возвращает true, если на событии был вызван preventDefault."
  },
  ...
  // ================ BROWSER ENVIRONMENT (36-45) ================
  {
    ...
    correct: [1],
    explanation: "BOM — объектная модель браузера, включающая window, navigator, location, history, screen и диалоговые окна."
  },
  {
    id: "browser-037",
    topic: "Browser Environment",
    ...
    correct: [1],
    explanation: "BOM включает: window (глобальный объект), navigator (инфо о браузере), location (URL), history (история), screen (экран)."
  },
  {
    id: "browser-038",
    topic: "Browser Environment",
    ...
    correct: [1],
    explanation: "navigator содержит информацию о браузере, ОС, userAgent, геолокации, батарее и т.д."
  },
  {
    id: "browser-039",
    topic: "Browser Environment",
  ...
  },
  {
    ...
    correct: [1],
    explanation: "Метод возвращает объект с top, left, right, bottom, width, height относительно viewport."
  },
  {
    id: "browser-042",
    topic: "Browser Environment",
    ...
    correct: [0],
    explanation: "Нужно добавить текущую прокрутку: rect.top + window.scrollY, rect.left + window.scrollX."
  },
  {
    id: "browser-043",
    topic: "Browser Environment",
    ...
    correct: [1],
    explanation: "window.matchMedia(query) возвращает объект MediaQueryList с методом matches и возможностью подписки на изменения через addEventListener."
  },
  {
    id: "browser-044",
    topic: "Browser Environment",
    ...
    correct: [1],
    explanation: "Feature detection проверяет наличие конкретной возможности напрямую. Это самый надежный способ."
  },
  {
    id: "browser-045",
    topic: "Browser Environment",
    ...
    correct: [1],
    explanation: "User-agent легко подделать, браузеры меняют формат строк, и наличие определенного UA не гарантирует поддержку функций."
  },
  ...
  },
  {
    ...
    correct: [0],
    explanation: "IntersectionObserver позволяет асинхронно отслеживать пересечение элемента с его родителем или viewport."
  },
  {
    id: "perf-048",
    topic: "Performance & Loading",
    ...
    correct: [1],
    explanation: "IntersectionObserver идеален для lazy loading, infinite scroll, отслеживания появления элементов в viewport."
  },
  {
    id: "perf-049",
    topic: "Performance & Loading",
    ...
    correct: [1],
    explanation: "window.close() может закрыть только окно, которое было открыто этим же скриптом. Попытка закрыть основное окно игнорируется."
  },
  {
    id: "perf-050",
    topic: "Performance & Loading",
    ...
    correct: [1],
    explanation: "document.forms возвращает HTMLCollection всех форм на странице (элементов <form>)."
  },
  ...
  // ================ COLLECTIONS & APIS (51-55) ================
  {
    ...
    correct: [0],
    explanation: "HTMLCollection (живая) содержит только элементы, NodeList (обычно статический) может содержать любые узлы и поддерживает forEach."
  },
  {
    id: "apis-052",
    topic: "Collections & APIs",
    ...
    correct: [1],
    explanation: "getElementsByTagName возвращает живую HTMLCollection, которая обновляется при изменении DOM."
  },
  {
    id: "apis-053",
    topic: "Collections & APIs",
    ...
    correct: [0],
    explanation: "submit() отправляет форму, игнорируя валидацию и не генерируя submit событие. requestSubmit() ведет себя как клик по кнопке submit."
  },
  {
    id: "apis-054",
    topic: "Collections & APIs",
    ...
    correct: [0],
    explanation: "URLSearchParams позволяет удобно работать с query-параметрами URL: получать, добавлять, удалять, сортировать параметры."
  },
  {
    id: "apis-055",
    topic: "Collections & APIs",
    ...
    correct: [0],
    explanation: "JSON — легковесный формат обмена данными, основанный на синтаксисе JavaScript. XML — более тяжелый язык разметки с тегами."
  }
];